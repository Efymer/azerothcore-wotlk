...
#ifndef ACORE_NET_SOCKET_H
#define ACORE_NET_SOCKET_H
...
#define ACORE_NET_READ_BLOCK_SIZE 4096
#ifdef BOOST_ASIO_HAS_IOCP
#define ACORE_SOCKET_USE_IOCP
#endif
...
concept SocketReadCallback = Acore::invocable_r<Callable, SocketReadCallbackResult>;
...
private:
    ...
    MessageBuffer _readBuffer = MessageBuffer(ACORE_NET_READ_BLOCK_SIZE);
