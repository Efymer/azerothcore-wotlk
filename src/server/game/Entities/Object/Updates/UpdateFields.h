...
// [54261] Ported from xian55 3.4.3 reference; AreaTrigger/Conversation/SceneObject/
// Azerite structs omitted (no matching AzerothCore entity).
...
{
    UpdateField<uint32, 0, 1> PetNumber;
    UpdateField<uint32, 0, 2> CreatureID;
    UpdateField<uint32, 0, 3> DisplayID;
    UpdateField<uint32, 0, 4> ExperienceLevel;
    UpdateField<uint8, 0, 5> PetSlot;
    UpdateField<uint8, 0, 6> PetFlags;
    UpdateField<std::string, 0, 7> Name;
