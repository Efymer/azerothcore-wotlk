...
// ChrClassesEntry migrated to DB2 (Task 1c.3) — see src/server/game/DataStores/DB2Structure.h
...
// FactionEntry and FactionTemplateEntry migrated to DB2 (build 3.4.3.54261).
// See src/server/game/DataStores/DB2Structure.h (structs + helpers) and DB2LoadInfo.h.
