...
{
    WorldPacket data(SMSG_LOOT_ROLL, (8 + 4 + 4 + 4 + 4 + 4 + 4 + 1));
...
{
    LOG_DEBUG("network", "Group::MasterLoot (SMSG_MASTER_LOOT_CANDIDATE_LIST, 330)");
    ...
    WorldPacket data(SMSG_MASTER_LOOT_CANDIDATE_LIST, 1 + looters.size() * (1 + 8));
