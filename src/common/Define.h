...
// The vendored bgs.protocol code under src/server/proto is machine-generated by
// protoc 2.6.1 and references the export macro TC_PROTO_API. Those .pb.h/.pb.cc
// files are kept byte-for-byte as produced by protoc, so we alias the upstream
// name to the AzerothCore macro here instead of editing the generated output.
#ifndef TC_PROTO_API
#  define TC_PROTO_API AC_PROTO_API
#endif
