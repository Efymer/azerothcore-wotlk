...
#ifndef ACORE_HTTP_COMMON_H
#define ACORE_HTTP_COMMON_H
...
AC_COMMON_API bool CanLogRequestContent(RequestContext const& context);
AC_COMMON_API bool CanLogResponseContent(RequestContext const& context);
