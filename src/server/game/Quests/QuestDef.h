...
enum QuestFlags
{
    ...
    QUEST_FLAGS_HIDDEN_REWARDS          = 0x00000200,   // Items and money rewarded only sent in SMSG_QUEST_GIVER_OFFER_REWARD_MESSAGE (not in SMSG_QUEST_GIVER_QUEST_DETAILS or in client quest log(SMSG_QUERY_QUEST_INFO_RESPONSE))
