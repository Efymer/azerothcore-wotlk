...
public:
    ...
    uint8 GetFreeTalentPoints() { return m_unitData->PetTalentPoints; }
    void SetFreeTalentPoints(uint8 points) { SetUpdateFieldValue(m_values.ModifyValue(&Unit::m_unitData).ModifyValue(&UF::UnitData::PetTalentPoints), points); }
