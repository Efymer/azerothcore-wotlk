...
public:
    ...
    bool PeekDecryptRecv(uint8* data, std::size_t length);
    bool DecryptRecv(uint8* data, std::size_t length, Acore::Crypto::AES::Tag& tag);
    bool EncryptSend(uint8* data, std::size_t length, Acore::Crypto::AES::Tag& tag);
