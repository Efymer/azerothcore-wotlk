...
// DbcFieldFormat (FT_*) moved to DBCFieldFormat.h so DBCStores.cpp can include DBCFileLoader.h
// (for GetFormatRecordSize) without pulling FT_* — which would clash with the DB2 DBCFormer enum.
