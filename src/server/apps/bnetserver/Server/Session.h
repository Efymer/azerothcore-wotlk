...
#ifndef AZEROTHCORE_BNET_SESSION_H
#define AZEROTHCORE_BNET_SESSION_H
...
namespace Battlenet
{
    class Session final : public Acore::Net::Socket<Acore::Net::SslStream<>>
    {
        using BaseSocket = Socket<Acore::Net::SslStream<>>;
    ...
    public:
        ...
        explicit Session(Acore::Net::IoContextTcpSocket&& socket);
        ~Session();
...
#endif // AZEROTHCORE_BNET_SESSION_H
