...
#ifndef ACORE_BASE_HTTP_SOCKET_H
#define ACORE_BASE_HTTP_SOCKET_H
...
class AC_COMMON_API AbstractSocket
{
public:
...
class BaseSocket : public Acore::Net::Socket<Stream>, public AbstractSocket
{
    using Base = Acore::Net::Socket<Stream>;
...
#endif // ACORE_BASE_HTTP_SOCKET_H
