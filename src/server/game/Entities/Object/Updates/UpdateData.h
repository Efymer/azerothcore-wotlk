...
public:
    ...
    [[nodiscard]] bool HasData() const { return m_blockCount > 0 || !m_outOfRangeGUIDs.empty() || !m_destroyGUIDs.empty(); }
    void Clear();

    [[nodiscard]] GuidSet const& GetOutOfRangeGUIDs() const { return m_outOfRangeGUIDs; }
