...
#ifndef ACORE_HTTP_SSL_SOCKET_H
#define ACORE_HTTP_SSL_SOCKET_H
...
{
class AC_COMMON_API SslSocket : public BaseSocket<SslStream<Impl::BoostBeastSocketWrapper>>
{
