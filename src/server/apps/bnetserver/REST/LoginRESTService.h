...
#ifndef AZEROTHCORE_BNET_LOGIN_REST_SERVICE_H
#define AZEROTHCORE_BNET_LOGIN_REST_SERVICE_H
...
private:
    ...
    static std::unique_ptr<Acore::Crypto::SRP::BnetSRP6Base> CreateSrpImplementation(SrpVersion version, SrpHashFunction hashFunction,
...
#endif // AZEROTHCORE_BNET_LOGIN_REST_SERVICE_H
